...
public:
	...
	virtual int findPosition(const string denumire, const string profesor, const vector<Disciplina>& discipline) const = 0;
...
public:
	...
	*/
	int findPosition(const string denumire, const string profesor, const vector<Disciplina>& discipline) const;
