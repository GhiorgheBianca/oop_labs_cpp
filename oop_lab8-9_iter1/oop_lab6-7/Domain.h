...
public:
	// constructor with parameters
	Contract(const vector<Disciplina>& discipline, int id_contract) :discipline{ discipline }, id_contract{ id_contract } {}
	...
	*/
	...
	/*
		Functia returneaza id-ul unei contract.
		Output: id_contract - int
	*/
	int getIdContract() const noexcept {
		return id_contract;
	}

	void setDiscipline_dinContract(vector<Disciplina> disciplinele) {
		discipline = disciplinele;
	}
